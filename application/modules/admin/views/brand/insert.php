...
if(isset($edit_record) && count($edit_record) > 0) {
    ...
    if($edit_record['image'] != null) {
        $avatar = base_url().'uploads/brands/'.$edit_record['image'];
    }
...
<h4 class="widgettitle nomargin shadowed"><?php echo $this->lang->line('brand_form'); ?></h4>
<div class="widgetcontent bordered shadowed nopadding">
    <form class="stdform stdform2" id="frmuser" method="post" action="" enctype="multipart/form-data">

        <p>
            <label><?php echo $this->lang->line('brand'); ?> (*) <?php echo "<small style='color:tomato'>".form_error('name')."</small>"; ?></label>
