...
{
    protected $_primaryKey = 'id_product';
    ...
    public function getAll($col = '',$val = '')
    {
        ...
        return $this->getList($this->_tbl_product, $col, $val);
    }
    ...
    {
        return $this->getCountWhere($this->_tbl_product);
    }
    ...
    {
        return $this->getCountAll($this->_tbl_product);
    }
    ...
    {
        return $this->delRows($this->_tbl_product, $this->_primaryKey, $val);
    }
    ...
    public function update_record($data = '', $col = '', $val = '')
    {
        ...
        return $this->updateRow($this->_tbl_product,$data,$col,$val);
    }
    ...
    {
        return $this->insertRow($this->_tbl_product,$data);
    }
    ...
    */
    ...
    {
         return  $this->insertGetId($this->_tbl_product,$data);
    }
