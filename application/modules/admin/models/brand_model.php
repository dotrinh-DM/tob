...
{
    protected $_primaryKey = 'id_brand';
    ...
    public function getAll($col = '',$val = '')
    {
        ...
        return $this->getList($this->_tbl_brand, $col, $val);
    }
    ...
    {
        return $this->getCountWhere($this->_tbl_brand);
    }
    ...
    {
        return $this->getCountAll($this->_tbl_brand);
    }
    ...
    {
        return $this->delRows($this->_tbl_brand, $this->_primaryKey, $val);
    }
    ...
    public function update_record($data = '', $col = '', $val = '')
    {
        ...
        return $this->updateRow($this->_tbl_brand,$data,$col,$val);
    }
    ...
    {
        return $this->insertRow($this->_tbl_brand,$data);
    }
    ...
    */
    ...
    {
         return  $this->insertGetId($this->_tbl_brand,$data);
    }
